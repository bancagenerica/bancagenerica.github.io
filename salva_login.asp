<%language="Vbscript"
    ...
    connection_string="Driver={MySQL ODBC 5.0.12 Driver};Server=sql11.freemysqlhosting.net;Port=3306;DB=sql11226831;UID=sql11229657@ec2-52-8-112-233.us-west-1.compute.amazonaws.com;"
